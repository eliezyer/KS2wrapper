...
rootH = '/mnt/SSD4TB/Preprocessing/'; 
...
ops.sigmaMask = 30; %EFO: I believe this is not used anymore but I need to double check
...
ops.NT                  = 64*2048+ ops.ntbuff; % must be multiple of 32 + ntbuff. This is the batch size (try decreasing if out of memory). 
